...
VERSION[AVBROOT_SETUP]="d95f549" # Commit hash
...
VERSION[LESSERAUDIO]="${VERSION[LESSERAUDIO]:-}"         # Lesser Audio Switch
...
ADDITIONALS[LESSERAUDIO]="${ADDITIONALS[LESSERAUDIO]:-true}"         # Lesser Audio Switch
